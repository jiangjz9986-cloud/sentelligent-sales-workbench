...
export const TOOL_DEFINITIONS = Object.freeze([
  ...
  tool("action-risk.create", "action-risk", "创建待办提醒", {
    title: { type: "string", required: true },
    remindAt: { type: "string", required: false },
  ...
  tool("action-risk.list", "action-risk", "查询待办清单", {
    dateStart: { type: "string", required: false },
    dateEnd: { type: "string", required: false },
    rangeLabel: { type: "string", required: false },
  }),
  tool("action-risk.complete", "action-risk", "完成待办", {
    actionItemId: { type: "string", required: false },
    query: { type: "string", required: false },
    expectedVersion: { type: "number", required: false },
  }),
  tool("action-risk.defer", "action-risk", "推迟待办提醒", {
    actionItemId: { type: "string", required: false },
    query: { type: "string", required: false },
    newTime: { type: "string", required: false },
    remindAt: { type: "string", required: false },
    due: { type: "string", required: false },
    expectedVersion: { type: "number", required: false },
  }),
  tool("action-risk.delete", "action-risk", "删除待办（软删除）", {
    actionItemId: { type: "string", required: false },
    query: { type: "string", required: false },
    expectedVersion: { type: "number", required: false },
  }),
