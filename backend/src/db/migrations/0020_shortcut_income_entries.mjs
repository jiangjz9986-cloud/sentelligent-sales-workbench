export function apply(db) {
  db.exec(`
    CREATE TABLE shortcut_bookkeeping_entries_0020 (
    ...
    INSERT INTO shortcut_bookkeeping_entries_0020 (
      ...
      status, attempt_count, lease_started_at, analysis_provider, analysis_model,
      analysis_json, warnings_json, occurred_on, amount_cents, merchant, purpose,
      expense_id, payment_id, remote_id, remote_reference, remote_status, error_code,
    ...
    DROP TABLE shortcut_bookkeeping_entries;
    ALTER TABLE shortcut_bookkeeping_entries_0020 RENAME TO shortcut_bookkeeping_entries;

    CREATE INDEX idx_shortcut_bookkeeping_owner_status
      ON shortcut_bookkeeping_entries(owner, status, created_at);
    CREATE INDEX idx_shortcut_bookkeeping_target
      ON shortcut_bookkeeping_entries(owner, target_system, occurred_on);
    CREATE UNIQUE INDEX idx_shortcut_bookkeeping_remote_identity
