...
| 项目 | 状态 |
| --- | --- |
| 当前代码 / GitHub Release | `v0.6.1`（已正式发布并完成生产切换） |
...
上述现网版本、release 路径、服务状态和健康接口已于 `2026-08-17` 复核。v0.6.1 HTTPS smoke run `0a00efbc-f349-424f-9700-0f3f08cda157` 通过 `25/25`，`cleanup=clean`，清理后无合成数据残留；SQLite `quick_check=ok`、外键违规 `0`。生产部署细节见 [部署记录](docs/部署记录.md)，版本边界和验收说明见 [v0.6.0 版本说明](docs/releases/v0.6.0.md) 与 [v0.6.1 版本说明](docs/releases/v0.6.1.md)。
