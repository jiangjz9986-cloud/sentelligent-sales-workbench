...
import { DEEPSEEK_FLASH_PRICE_CALENDAR, DEEPSEEK_PRICING_SOURCE_URL } from "../../shared/deepseekContract.mjs";
...
const policy = {
  ...
  models: [{
    id: "model-deepseek", providerId: "provider-deepseek", name: "deepseek-flash",
    price: {
      id: "price-deepseek-test", version: "test-v1", effectiveFrom: "2026-01-01T00:00:00.000Z",
      sourceUrl: DEEPSEEK_PRICING_SOURCE_URL,
      calendar: DEEPSEEK_FLASH_PRICE_CALENDAR,
      input_micro_per_1k: 2000, output_micro_per_1k: 8000, cached_input_micro_per_1k: 40,
