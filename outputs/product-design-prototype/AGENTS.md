...
Information architecture is fixed at nine primary modules. Customer profile owns customer records and tender monitoring; opportunity owns records, risk recognition, next actions, and Kanban; system settings owns AI security, WeChat binding, PushPlus notification, and tender scheduling. Keep tender business results under customer profile and all scheduler/notification controls under system settings.
