  ...
  return (
    <section className="expense-list-print-preview" data-testid="expense-list-print-preview">
      <header className="expense-print-preview-toolbar expense-list-print-toolbar no-print">
        <div><button className="ghost-button" type="button" data-testid="expense-list-print-preview-back" onClick={onClose}><ArrowLeft size={16} />返回账本</button><div><strong>费用清单</strong><span>账本 / A4 纵向预览</span></div></div>
